...
# fix v1beta1 crds - see https://github.com/kubernetes-sigs/controller-tools/issues/445
	grep -lR "default:" deploy/crds/legacy | xargs sed -i.bak '/default:/d'
	grep -lR "x-kubernetes-preserve-unknown-fields:" deploy/crds/legacy | xargs sed -i.bak '/x-kubernetes-preserve-unknown-fields:/d'
